        ...
        <div className="relative z-10 flex flex-col justify-center px-16 text-white">
          <div className="mb-12">
            <div className="flex items-center gap-3 mb-2">
              <span className="font-display text-4xl font-black tracking-tight">RPGCC</span>
              <div className="flex items-center gap-1.5">
                <div className="w-3 h-3 rounded-full bg-rpgcc-blue" />
                <div className="w-3 h-3 rounded-full bg-rpgcc-red" />
                <div className="w-3 h-3 rounded-full bg-rpgcc-amber" />
              </div>
            </div>
            <span className="text-white/60 font-medium">AI Portal</span>
          </div>
          ...
          <div className="absolute bottom-16 left-16 right-16">
            <div className="flex gap-4">
              <div className="flex-1 h-1 rounded-full bg-rpgcc-blue/40" />
              <div className="flex-1 h-1 rounded-full bg-rpgcc-red/40" />
              <div className="flex-1 h-1 rounded-full bg-rpgcc-amber/40" />
            </div>
          </div>
        </div>
      </div>
